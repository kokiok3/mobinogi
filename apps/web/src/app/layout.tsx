...
export const metadata: Metadata = {
  ...
  keywords: ['마비노기 모바일 랭크', '마비노기 모바일 순위', '마비노기 모바일 랭킹', '마비노기 모바일 전투력', '마비노기', '마비노기 모바일', '모비노기', '모비랭크', '모비랭킹', '모비랭커', '마비노기 랭킹', '마비노기 랭크', '마비노기 순위', '마비노기 전투력', '마비노기 매력', '마비노기 생활', '마비노기 통합', '마비노기 서버통합', '모비노기 랭크', '모비노기 순위', '모비노기 전투력', '모비노기 매력', '모비노기 생활'],
